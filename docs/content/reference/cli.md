...
```
tiengtrungbotui <command> [arguments] [flags]
```

Run `tiengtrungbotui <command> --help` for the full flag list on any command. This
...
per operation you declare in `tiengtrungbotui/domain.go`.
