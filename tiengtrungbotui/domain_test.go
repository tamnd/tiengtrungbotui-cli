...
// HTTP behaviour is covered in tiengtrungbotui_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "tiengtrungbotui://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("tiengtrungbotui", "about")
	if err != nil || got.String() != "tiengtrungbotui://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want tiengtrungbotui://page/about", got.String(), err)
	}
}
